...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    <div class="layui-logo">欢迎${teacher.tname }老师登录</div>
    ...
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            <dd><a href="javascript:addTab('分组管理','<%=basePath%>teacher/groupStudent.jsp');" id="teacher">分组管理</a></dd>
            <dd><a href="javascript:addTab('成绩管理','<%=basePath%>teacher/gradeStudent.jsp');">成绩管理</a></dd>
            <dd><a href="javascript:addTab('违规管理','<%=basePath%>teacher/RecordStudent.jsp');">违规管理</a></dd>
        ...
        <li class="layui-nav-item">
          ...
          <dl class="layui-nav-child">
            <dd><a href="javascript:addTab('文件列表','<%=basePath%>teacher/File.jsp');">文件列表</a></dd>
          </dl>
        </li>
...
setInterval("jnkc.innerHTML=new Date().toLocaleString()+' 星期'+'日一二三四五六'.charAt(new Date().getDay());",1000);
	...
	var tid='${sessionScope.teacher.tid}';
	layui.use(['layer','element','form','jquery'], function(){
		  ...
		  $('#btnSave').click(function(){
			var url='<%=basePath%>teacher/update?id='+tid;
			layer.open({
			  type: 2,
			  title: '信息修改',
			  shadeClose: true,
