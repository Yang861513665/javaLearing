...
public class TeacherLoginFilter implements Filter{
	...
	public void doFilter(ServletRequest arg0, ServletResponse arg1,
		...
		//获取session
				...
				if(urlPath.endsWith("index.jsp")||urlPath.endsWith("login")||urlPath.endsWith("querystudent")||urlPath.endsWith("querystudent?flag=save")||urlPath.endsWith("upload.jsp")||urlPath.endsWith("searchstudentname.jsp")){
					//去登录界面，不拦截
