...
public class Client3 extends JFrame implements Runnable {
	/**
	 * 实现广播通信
	 * */
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
					...
					try {
						//指定发送端端口
						sendSocket = new DatagramSocket(3333);
						Client3 frame = new Client3( sendSocket);
	 ...
	 * Create the frame.
	 */
	public Client3( final DatagramSocket  sendSocket) {
